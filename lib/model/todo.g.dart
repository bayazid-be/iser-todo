...
void _todoSerialize(
  ...
  writer.writeDateTime(offsets[1], object.createedAt);
...
Todo _todoDeserialize(
  ...
  object.createedAt = reader.readDateTime(offsets[1]);
  object.id = id;
...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> createedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'createedAt',
        value: value,
      ));
    });
  }

  QueryBuilder<Todo, Todo, QAfterFilterCondition> createedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> createedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> createedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByCreateedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createedAt', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByCreateedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createedAt', Sort.desc);
    });
  }
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByCreateedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createedAt', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByCreateedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createedAt', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctByCreateedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'createedAt');
    });
  }
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, DateTime, QQueryOperations> createedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createedAt');
    });
  }
